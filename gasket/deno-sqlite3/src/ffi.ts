...
export const symbols = {
  ...
  sqlite3_backup_finish: {
    parameters: ["pointer" // sqlite3_backup *p
    ],
    result: "i32"
  },
  ...
  sqlite3_result_null: {
    parameters: ["pointer" // sqlite3_context *p
    ],
    result: "void"
  },
  sqlite3_result_text: {
  ...
  sqlite3_value_type: {
    parameters: ["pointer" // sqlite3_value *pVal
    ],
    result: "i32"
  },
...
export const init = lib.sqlite3_initialize();
if (init !== 0) {
